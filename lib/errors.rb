...
# CustomErrors module defines custom error classes for the Connect Four game.
module CustomErrors
  ...
  class PlayerLimitViolation < StandardError
    ...
    #
    # msg - The message to be displayed for the error (default: 'Connect Four only allows up to 2 players.').
    # exception_type - The type of exception (default: 'custom').
    #
    # Returns a new PlayerLimitViolation object.
    def initialize(msg = 'Connect Four only allows up to 2 players.', exception_type = 'custom')
  ...
  class BoardLimitViolation < StandardError
    ...
    #
    # msg - The message to be displayed for the error (default: 'Connect Four only allows 1 board.').
    # exception_type - The type of exception (default: 'custom').
    #
    # Returns a new BoardLimitViolation object.
    def initialize(msg = 'Connect Four only allows 1 board.', exception_type = 'custom')
      @exception_type = exception_type
      super(msg)
    end
  end
